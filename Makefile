...
Makefile: moneta-qt.pro ../mxe/usr/i686-w64-mingw32.static/qt5/mkspecs/win32-g++/qmake.conf ../mxe/usr/i686-w64-mingw32.static/qt5/mkspecs/features/spec_pre.prf \
...
clean: release-clean debug-clean  FORCE
	-$(DEL_FILE) /mnt/moneta-1.0.1.0/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) /mnt/moneta-1.0.1.0/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) clean
distclean: release-distclean debug-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) /mnt/moneta-1.0.1.0/moneta-qt_plugin_import.cpp

/mnt/moneta-1.0.1.0/src/leveldb/libleveldb.a: FORCE
	cd /mnt/moneta-1.0.1.0/src/leveldb && CC=i686-w64-mingw32.static-gcc CXX=i686-w64-mingw32.static-g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && i686-w64-mingw32.static-ranlib /mnt/moneta-1.0.1.0/src/leveldb/libleveldb.a && i686-w64-mingw32.static-ranlib /mnt/moneta-1.0.1.0/src/leveldb/libmemenv.a
