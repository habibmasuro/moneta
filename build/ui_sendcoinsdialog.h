...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 MONET"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 MONET"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 MONET"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 MONET"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.456 MONET", 0));
#ifndef QT_NO_TOOLTIP
