...
public:
    ...
    MonetaAmountField *transactionFee;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        monetaAtStartup = new QCheckBox(tabMain);
        monetaAtStartup->setObjectName(QStringLiteral("monetaAtStartup"));

        verticalLayout_Main->addWidget(monetaAtStartup);
        ...
        transactionFee = new MonetaAmountField(tabWallet);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        monetaAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Moneta after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        monetaAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Moneta on system login", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Moneta client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Moneta network through a SOCKS proxy (e.g. when connecting through Tor).", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Moneta.", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show Moneta addresses in the transaction list or not.", 0));
#endif // QT_NO_TOOLTIP
